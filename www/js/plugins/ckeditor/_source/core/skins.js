...
CKEDITOR.skins = (function()
{
	...
	var loadPart = function( editor, skinName, part, callback )
	{
		...
		else
		{
			...
			// We may have more than one skins part load request. Just the first
	...
	return /** @lends CKEDITOR.skins */ {
		...
		/**
		 * Registers a skins definition.
		 * @param {String} skinName The skins name.
		 * @param {Object} skinDefinition The skins definition.
		 * @example
		 */
		...
		/**
		 * Loads a skins part. Skins are defined in parts, which are basically
		 * separated CSS files. This function is mainly used by the core code and
		 * should not have much use out of it.
		 * @param {String} skinName The name of the skins to be loaded.
		 * @param {String} skinPart The skins part to be loaded. Common skins parts
		 *		are "editor" and "dialog".
		 * @param {Function} [callback] A function to be called once the skins
