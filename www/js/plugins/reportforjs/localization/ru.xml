...
<Localization language="Russian" description="Русский" cultureName="ru">
  ...
  <Adapters>
    ...
    <AdapterOleDbConnection>Данные из OleDb соединения</AdapterOleDbConnection>
  ...
  <ChartRibbon>
    ...
    <AxesXTopAxis>Верхняя ось X</AxesXTopAxis>
    <AxesYAxis>Ось Y</AxesYAxis>
    <AxesYRightAxis>Правая ось Y</AxesYRightAxis>
    ...
    <HorAlLeft>&lt;b&gt;Наложить легенду слева&lt;/b&gt;&lt;br&gt;Накладывать легенду слева диаграммы&lt;/br&gt;&lt;br&gt;без изменения размеров диаграммы&lt;/br&gt;</HorAlLeft>
    <HorAlLeftOutside>&lt;b&gt;Показывать легенду слева&lt;/b&gt;&lt;br&gt;Показывать легенду слева от диаграммы&lt;/br&gt;</HorAlLeftOutside>
    <HorAlRight>&lt;b&gt;Наложить легенду справа&lt;/b&gt;&lt;br&gt;Накладывать легенду справа диаграммы&lt;/br&gt;&lt;br&gt;без изменения размеров диаграммы&lt;/br&gt;</HorAlRight>
  ...
  <Database>
    ...
    <DatabaseOleDb>OleDB соединение</DatabaseOleDb>
  ...
  <DesignerFx>
    ...
    <ExportingReport>Экспорт отчёта</ExportingReport>
    ...
    <SavingReport>Сохранение отчёта</SavingReport>
  ...
  <Errors>
    ...
    <NameExists>Повторяющееся имя компонента '{0}'.  Имена компонентов должны быть уникальными и независящими от регистра.</NameExists>
  ...
  <FileFilters>
    ...
    <BmpFiles>BMP изображение (*.bmp)|*.bmp</BmpFiles>
    ...
    <DictionaryFiles>Файлы словаря (*.dct)|*.dct</DictionaryFiles>
    <DifFiles>DIF файлы (*.dif)|*.dif</DifFiles>
    <DllFiles>DLL файлы (*.dll)|*.dll</DllFiles>
    <DocumentFiles>Файлы документов (*.mdc)|*.mdc</DocumentFiles>
    <EmfFiles>Metafile (*.emf)|*.emf</EmfFiles>
    <EncryptedDocumentFiles>Закодированные файлы документов (*.mdx)|*.mdx</EncryptedDocumentFiles>
    <EncryptedReportFiles>Закодированные файлы отчетов (*.mrx)|*.mrx</EncryptedReportFiles>
    ...
    <GifFiles>GIF изображение (*.gif)|*.gif</GifFiles>
    <HtmlFiles>HTML файлы (*.html)|*.html</HtmlFiles>
    <InheritedLanguageFiles>{0} файлы для унаследованных отчетов (*.{1})|*.{2}</InheritedLanguageFiles>
    <JpegFiles>JPEG изображение (*.jpeg)|*.jpeg</JpegFiles>
    <LanguageFiles>{0} файлы (*.{1})|*.{2}</LanguageFiles>
    <LanguageForSilverlightFiles>{0} файлы для Silverlight отчетов (*.{1})|*.{2}</LanguageForSilverlightFiles>
    <MetaFiles>Векторные изображения</MetaFiles>
    <MhtFiles>MHT Web файл архива (*.mht)|*.mht</MhtFiles>
    <PackedDocumentFiles>Упакованные файлы документов (*.mdz)|*.mdz</PackedDocumentFiles>
    <PackedReportFiles>Упакованные файлы отчетов (*.mrz)|*.mrz</PackedReportFiles>
    <PageFiles>Файлы страницы (*.pg)|*.pg</PageFiles>
    <PcxFiles>PCX изображение (*.pcx)|*.pcx</PcxFiles>
    <PdfFiles>Adobe PDF файлы (*.pdf)|*.pdf</PdfFiles>
    <PngFiles>PNG изображение (*.png)|*.png</PngFiles>
    <Ppt2007Files>Microsoft PowerPoint 2007/2013 файлы (*.pptx)|*.pptx</Ppt2007Files>
    <ReportFiles>Файлы отчета (*.mrt)|*.mrt</ReportFiles>
    <RtfFiles>Текст в формате Rich Text (*.rtf)|*.rtf</RtfFiles>
    <StandaloneReportFiles>Автономный отчет (*.exe)|*.exe</StandaloneReportFiles>
    <StylesFiles>Файлы стилей (*.sts)|*.sts</StylesFiles>
    <SvgFiles>SVG изображение (*.svg)|*.svg</SvgFiles>
    <SvgzFiles>Compressed SVG изображение (*.svgz)|*.svgz</SvgzFiles>
    <SylkFiles>SYLK файлы (*.slk)|*.slk</SylkFiles>
    <TiffFiles>TIFF изображение (*.tiff)|*.tiff</TiffFiles>
  ...
  <FormDatabaseEdit>
    ...
    <OleDbEdit>Изменение OleDb соединения</OleDbEdit>
    <OleDbNew>Новое OleDb соединение</OleDbNew>
    ...
    <UniDirectNew>Новое Uni Direct соединения</UniDirectNew>
  ...
  <FormDesigner>
    ...
    <WebPreview>Web просмотр</WebPreview>
  </FormDesigner>
  ...
  <FormOptions>
    <AutoSave>Авто-сохранение</AutoSave>
    ...
    <EnableAutoSaveMode>Включить режим авто-сохранения</EnableAutoSaveMode>
  ...
  <FormTitles>
    ...
    <GroupConditionForm>Условие группировки</GroupConditionForm>
  ...
  <FormViewer>
    ...
    <Save>Сохранить</Save>
    <SendEMail>Отправить по E-Mail...</SendEMail>
  ...
  <HelpDesigner>
    ...
    <BorderSidesAll>Уставить границу у выделенных компонентов со всех сторон.</BorderSidesAll>
    <BorderSidesBottom>Уставить границу у выделенных компонентов с нижней стороны.</BorderSidesBottom>
    <BorderSidesLeft>Уставить границу у выделенных компонентов с левой стороны.</BorderSidesLeft>
    <BorderSidesNone>Сбросить границу у выделенных компонентов со всех сторон.</BorderSidesNone>
    <BorderSidesRight>Уставить границу у выделенных компонентов с правой стороны.</BorderSidesRight>
    <BorderSidesTop>Уставить границу у выделенных компонентов с верхней стороны.</BorderSidesTop>
    ...
    <FormatBoolean>Этот формат используется для форматирования значений булева типа.</FormatBoolean>
    ...
    <MakeVerticalSpacingEqual>Позволяет установить равные вертикального расстояния между отдельными компонентами.</MakeVerticalSpacingEqual>
  ...
  <HelpViewer>
    ...
    <FullScreen>Полно-экранный просмотр отчета.</FullScreen>
    ...
    <SendEMail>Послать отчет по E-Mail.</SendEMail>
  ...
  <PropertyEnum>
    ...
    <PictureBoxSizeModeAutoSize>Авто размер</PictureBoxSizeModeAutoSize>
    ...
    <StiEmptySizeModeDecreaseLastRow>Уменьшать высоту последней строки</StiEmptySizeModeDecreaseLastRow>
    ...
    <StiSeriesYAxisLeftYAxis>Левая ось Y</StiSeriesYAxisLeftYAxis>
    <StiSeriesYAxisRightYAxis>Правая ось Y</StiSeriesYAxisRightYAxis>
  ...
  <PropertyEvents>
    ...
    <ConnectedEvent>После соединение</ConnectedEvent>
  ...
  <PropertyMain>
    ...
    <AspectRatio>Отношение координат</AspectRatio>
    <Author>Автор</Author>
    <Auto>Авто</Auto>
    ...
    <DetectUrls>Определять гипер-ссылки</DetectUrls>
    ...
    <Key>Ключ</Key>
    <KeyDataColumn>Ключевой Столбец Данных
Колонка данных с ключом</KeyDataColumn>
    <Keys>Ключи</Keys>
    ...
    <XAxis>Ось X</XAxis>
    <XTopAxis>X Ось Верхняя</XTopAxis>
    <YAxis>Ось Y</YAxis>
    <YRightAxis>Y Ось Правая</YRightAxis>
    <Zoom>Масштаб</Zoom>
  </PropertyMain>
  ...
  <Questions>
    ...
    <qnPageDelete>Удалить страницу?</qnPageDelete>
    <qnRemove>Удалить?</qnRemove>
  ...
  <Report>
    ...
    <CrossBands>Кросс-секции</CrossBands>
    ...
    <LabelExpression>Выражения:</LabelExpression>
  ...
  <Wizards>
    ...
    <OpenExistingReport>Открыть отчет</OpenExistingReport>
    <Preview>Предварительный просмотр</Preview>
