...
<Localization language="Lithuanian" description="Lietuvių" cultureName="lt">
  ...
  <Adapters>
    ...
    <AdapterOleDbConnection>Duomenys iš OleDb prisijungimo</AdapterOleDbConnection>
  ...
  <Errors>
    ...
    <NameExists>Komponentė pavadinta '{0}' jau yra. Komponentės privalo turėti unikalius vardus (didž./maž. raidės neskiriamos).</NameExists>
  ...
  <FileFilters>
    ...
    <JpegFiles>JPEG paveikslėliai (*.jpeg)|*.jpeg</JpegFiles>
  ...
  <FormDatabaseEdit>
    ...
    <OleDbEdit>Redaguoti OleDb prisijungimas</OleDbEdit>
    <OleDbNew>Naujas OleDb prisijungimas</OleDbNew>
