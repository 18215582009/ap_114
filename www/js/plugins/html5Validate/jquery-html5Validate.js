		...
		return {
			...
			isAllpass: function(elements, options) {
				...
				elements.each(function(){
					...
					//wangjiang begin
					var servicevali = el.getAttribute("servicevalidate");
					if(servicevali){
						var resfun = eval(servicevali);
						if(resfun&&resfun.res==false){
							remind(el, "servicevalidate",resfun.msg);
							allpass = false;
						}
					}
					//wangjiang end
