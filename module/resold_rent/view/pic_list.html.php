                                    ...
                                    <div class="panel-body">
                                        <div class="gallery-pages">
                                            ...
                                            <div class="row mix-grid mtl">
                                            	  <? foreach ($list['path_img'] as $key => $value) {  ?>   
                                            	<div class="col-md-4 col-lg-3 mix pic<?=$key?>" style="display: inline-block;">
                                                	<div class="thumbnail">
                                                    <div class="caption" style="display: none;">
                                                    	<h4><?=$list['title']?>标题</h4>
                                                        <p>
                                                           <a class="label label-default mix-zoom mrs" href="" >取消</a>
                                                            ...
                                                            <a class="label label-danger mix-zoom mrs" data-lightbox="image-1" rel="tooltip" href="" >查看</a>
                                                        </p>
                                                    </div>
                                                      <img alt="..." src="<?=$value?>">
...
{
	art.dialog.open('/resold_sale/addPic?project_id='+project_id,{
		title: '',
		width: '85%',
		height: '90%',
		lock: 'true',
