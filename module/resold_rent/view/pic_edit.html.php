...
<div class="page-content">
	...
	<div class="box-content">
      <!--begin content-->
      <div class="content">
      	<form action="<?=$handle?>Pic.html?action=save" id="opform" name="opform"  method="post" enctype="multipart/form-data">
        <input type="hidden" value="<?=$Info['project_id']?>" name="id" id="id" />
        <input type="text" value="<?=$Info['project_id']?>" name="project_id" id="project_id" style="display:none;">
          <div class="row">
            <div class="col-md-12">
              <div class="panel">
                ...
                <div class="panel-body">
                	...
                	<div class="row">
                        <div class="col-md-4">
                            ...
                            <label class="control-label" for="total_apa">图片</label>
                            <input type="file"  value="" placeholder="请上传图片" name="url" id="url" class="form-control " />
                            </div>
                        </div>
                        
                        <div class="col-md-8">
                           <?=Form::textarea('des',123,$handle,'图片描述');?>
                        </div>
                    </div>
