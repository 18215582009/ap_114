 ...
 * @package     CandorPHP
 * @version     $Id: index.html.php,v 1.4 2014/06/05 09:57:01 lj Exp $
 */
?>
...
<script type="text/javascript">
	...
	$(document).ready(function () {
		...
		$("#leftFrame").attr("src","/cyzt_rolemanager/rolelist.candor");
		$("#mainFrame").attr("src","/cyzt_rolemanager/editrole.candor?groupid=<?=$firstgroup["ID"]?>&type=view");
	});
	
	function refreshtree(pid){
		document.frames("leftFrame").src="http://www.baidu.com"; 
	}
	function deldialog(groupid){
		art.dialog({
			content: '确实要删除该角色吗?',
			ok: function () {				
				$("#mainFrame").attr("src","/cyzt_rolemanager/setgroupstatus.candor?groupid="+groupid+"&type=del");
				return true;				
			},
			cancelVal: '关闭',
...
<body>
	<div class="ui-layout-north" style="padding:0; border-top:none; border-bottom:none">
	...
	<iframe id="leftFrame" name="leftFrame" class="ui-layout-west" width="100%" height="600" frameborder="0" scrolling="auto" src="" style="border-right:solid 1px #96A4B1;border:none;background:#CCE0F1"></iframe>

	<iframe id="mainFrame" name="mainFrame" class="ui-layout-center" width="100%" height="600" frameborder="0" scrolling="auto" src="" style="border-left:solid 1px #96A4B1;border:none;background:#CCE0F1"></iframe>	
