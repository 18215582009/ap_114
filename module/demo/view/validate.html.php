...
<title>jQuery html5Validate表单验证插件测试</title>
...
<div class="zxx_out_box">
    <div class="zxx_in_box">
        ...
        <div class="zxx_main_con">
			<form action="/demo/dovalidate.candor" method="post" id="opform">
				<div class="mb10">
                	用户名：<input type="text" name="username" required servicevalidate="test()" />
                    <span class="f9 g6 ml10">后台验证用户名是否唯一</span>
                </div>
                <div class="mb10">
                ...
                <input type="submit" class="submit" value="提交测试"  id="valisubmit"/>
            </form>        
        </div>
    </div>
</div>
...
function test(){alert(1);
	var returnRes = {res:true,msg:""};
	var tmp = $("input[name='username']").val();
	if(tmp){
		$.ajax({
	   		type: "GET",
	   		url: "/demo/ajax.php",
		...
		returnRes.res = false;
		returnRes.msg = '字段不能为空';
	}
	return returnRes;
}
$("#opform").html5Validate(function() {
}, {
	// novalidate: false	
});
// 拖选
