...
<style>
    ...
    .dropdown-menu li:hover { background-color: #ECEFF1;}
    .dropdown-menu li a{color: #777777; padding:12px 20px; font-size: 14px;}
    #topbar #topbar-menu ul.navbar-nav > li > ul li a:hover{color: #000;}
</style>
        ...
        <div class="container-fluid pln prn">
            <div class="navbar-collapse pln prn" id="topbar-menu">
                <ul class="nav navbar-nav logo-wrapper">
                    <li class="btn-menu-toggle" style="display: none">
                        <div class="show-collapsed" id="menu-toggle"><i class="fa fa-bars"></i></div>
                    </li>
                    <? if($this->session->user_type==10){ ?>
                    <li class="pull-left"><a class="pan" href="index.html" id="logo"><img src="/theme/agency/img/logo-darkgreen.png"/></a></li>
                    <? }else{ ?>
                    <li class="pull-left"><a class="pan" href="index.html" id="logo"><img src="/images/clientlogo4@2x.png"/></a></li>
                    <? } ?>
                </ul>
                        ...
                        <ul class="dropdown-menu dropdown-task dropdown-topbar">
                            ...
                            <li>
                                <div class="dropdown-slimscroll">
                                    <ul>
                                        <li class="unread">
                                            <a href="#" target="_blank">张海约下午6点看房
                                                <span class="label label-success pull-right">紧急</span><br/>
                                                <span class="text-muted small">4分钟前</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#" target="_blank">张海约下午6点看房
                                                <span class="label label-info pull-right">一般</span><br/>
                                                <span class="text-muted small">12分钟前</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#" target="_blank">张海约下午6点看房
                                                <span class="label label-warning pull-right">重要</span><br/>
                                                <span class="text-muted small">15分钟前</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#" target="_blank">张海约下午6点看房
                                                <span class="label label-default pull-right">一般</span><br/>
                                                <span class="text-muted small">18分钟前</span>
                                            </a>
                                        </li>
                                        <li><a href="#" target="_blank">张海约下午6点看房
                                                <span class="label label-success pull-right">一般</span><br/>
                                                <span class="text-muted small">2天前</span>
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                                    ...
                                    <ul>
                                        <li class="unread">
                                            <a href="extra-user-list.html" target="_blank">
                                                <span class="label label-info"><i class="fa fa-comment"></i></span>
                                                最新评论<span class="pull-right text-muted small">4分钟前</span>
                                            </a>
                                        </li>
                                        <li class="unread">
                                            <a href="extra-user-list.html" target="_blank">
                                                <span class="label label-success"><i class="fa fa-twitter"></i></span>
                                                3个客户<span class="pull-right text-muted small">12分钟前</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="extra-user-list.html" target="_blank">
                                                <span class="label label-warning"><i class="fa fa-envelope"></i></span>
                                                消息发送<span class="pull-right text-muted small">15分钟前</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="extra-user-list.html" target="_blank">
                                                <span class="label label-success"><i class="fa fa-tasks"></i></span>
                                                最新任务<span class="pull-right text-muted small">18分钟前</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="extra-user-list.html" target="_blank">
                                                <span class="label label-danger"><i class="fa fa-upload"></i></span>
                                                重置账户<span class="pull-right text-muted small">19分钟前</span>
                                            </a>
                                        </li>
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li>
                        <a target="_blank" class="btn" href="/"><i class="fa fa-question-circle"></i>&nbsp;使用指南</a>
                    </li>
                    <li class="hidden-xs" id="topbar-chat" style="display:none">
                        <a class="btn-chat" href="javascript:void(0)">
                            <i class="fa fa-comments-o"></i><span class="badge badge-warning">3</span>
                        </a>
                    </li>
                    <li class="dropdown">
                        <a class="dropdown-toggle" href="#" data-toggle="dropdown">
                            <i class="glyphicon glyphicon-user"></i>&nbsp;<?=$_SESSION['username']?>&nbsp;<span class="caret"></span>
                        </a>
                        <ul class="dropdown-menu dropdown-user pull-right">
                            <li><a href="/user_account/baseInfo"><i class="icon-user"></i> 基础信息</a></li>
                            <li><a href="/user_account/modifyPw"><i class="icon-key"></i> 修改密码 </a> </li>
                            <li><a href="/user_account/safe"><i class="icon-shield"></i> 账号安全 </a> </li>
                            <li><a href="/userlogin/logout?type=index"><i class="icon-logout"></i> 系统退出 </a> </li>
                        </ul>
                    </li>
                    <li class="hidden-sm hidden-xs" style="display:none;">
                        <a class="btn-template-setting" href="#"><i class="icon-settings"></i></a>
                    </li>
                </ul>
            </div>
        </div>
