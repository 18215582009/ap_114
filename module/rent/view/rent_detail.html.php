...
<style>
    ...
    #thumbs .picborder img {float:left;width:84px;height:58px; }
...
<!--                            </div>-->
                ...
                <div class="col-md-5" style="width: 44.33333333%">
                    <div class="inforTxt clearfix">
                        <dl>
                            <dt>
                                <span class="gray6">租<span class="plxl"></span>金：</span>
                                <span class="red28b"><?=round($sale_detail[0]['price'])==0?'待定':round($sale_detail[0]['price']).'</span>元/月'?>
                            </dt>
                            <dd class="gray6">租金押付：<span class="black "><?if(isset($this->config->pay_way_option[$sale_detail[0]['rent_deposit']])){ ?><?=$this->config->pay_way_option[$sale_detail[0]['rent_deposit']]?><?}else{echo "暂无";}?></span></dd>
                            <dd class="gray6">装修：<span class="black "><? if(isset($this->config->fitment_option[$sale_detail[0]['fitmen_type']]) && $sale_detail[0]['fitmen_type']!=0){ ?><?=$this->config->fitment_option[$sale_detail[0]['fitmen_type']]?><?}else{echo "暂未装修";}?></span></dd>
                            ...
                            <dd class="gray6">面积：<span class="black "><?if(round($sale_detail[0]['total_area'])!=''&&round($sale_detail[0]['total_area'])!=0){echo round($sale_detail[0]['total_area']).'平米';}else{echo "未知";}?></span></dd>
                        </dl>
                        <dl style=" clear:both;">
                        ...
                        <dl style=" clear:both;">
                            <dd><span class="gray6">产权性质：</span><? if(isset($this->config->pright_option[$sale_detail[0]['pright']])){echo $this->config->pright_option[$sale_detail[0]['pright']];}else{echo "未知";} ?></dd>
                            ...
                            <div class="col-md-12">
                                <div class="first-col left">
                                    ...
                                    <dl><dt>位置：</dt>
                                        <dd>
                                            <span class="loc-text">
                                                <? if($district[0]['borough']=='' && $district[0]['address']==''){echo "未提供地址";}else{ ?>
                                ...
                                <div class="third-col left">
                                    ...
                                    <dl><dt>房屋单价：</dt><dd><?=round($sale_detail[0]['price'])==0?'待定':round($sale_detail[0]['price']).'</span>元/月'?></dd></dl>
                                </div>
                            </div>
                        </div>
                    </div>
