                    ...
                    <div class="col-lg-12">
                      <div class="panel">
                        ...
                        <div class="panel-body">
                            <div class="row">
                              <div class="col-md-4">
                              	<?=Form::input('reside',empty($Info['reside'])? '':$Info['reside'],$handle,'楼盘名称');?>
                    
                                <?=Form::input('address',empty($Info['address'])? '':$Info['address'],$handle,'小区地址');?>
                               ...
                               <div class="col-md-4">
                                ...
                                <?=Form::select_multiple('pm_type[]',$this->config->pm_type_option,empty($Info['pm_type'])?'':$Info['pm_type'],$handle,'物业类型');?>
