...
.text-block p {width:100%;padding-top:20px;}
.text-block p a{color:#ffffff; font-weight:200; display:inline-block;padding: 0 15px 14px 0;}
...
.intro {
	background: #81c95b url(../theme/agency/img/banner1.jpg) repeat 50% 50%;
...
<a class="navbar-brand logo-crop" href="#page-top"> <img src="../theme/agency/img/logo-green.png" alt="FC114"> </a> </div>
...
<div class="col-md-10 col-md-offset-1">
    <h1 class="animated fadeInLeft brand-heading">乐山城市房产综合服务平台</h1>
    <p class="animated fadeInUp intro-text"><br>
    	<span itemprop="name">城市房产服务平台</span> 是一个 <b>权威</b> 和 <b>公正</b> 的房产信息服务平台 <br>最权威、最真实的房屋验证、评估、监管服务！
    </p>
...
<div class="content-section text-center how-section container">
    <div class="row margin_none">
        <div class="col-md-12">
            <div class="col-xsm-12 col-md-7">	
				<canvas id="myChart" width="650" height="350"></canvas>
            	<!--<img itemprop="screenshot" src="../theme/agency/img/trend-m.png" alt="Banner Image" class="img-rounded">-->
            </div>
	...
	datasets : [
		{
			...
			pointColor : "#f2a730", // 点
			pointStrokeColor : "#9dd1f7",// 点的包围圈
			data : [7560,7840,8000,8420,8422,8540,8560]// Y轴坐标
		},
/*		{
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">专家信息</h4>
      </div>
