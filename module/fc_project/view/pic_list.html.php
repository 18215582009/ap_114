                                    ...
                                    <div class="panel-body">
                                        <div class="gallery-pages">
                                            ...
                                            <div class="action-group btn-group pull-right mtm mbm">
                                                <button class="btn btn-success mrm" onclick="addPic(<?=$project_id?>)"><i class="fa fa-upload mrs"></i>上传</button>
                                            ...
                                            <div class="row mix-grid mtl">
                                            	...
                                            	<div class="col-md-4 col-lg-3 mix pic<?=$val['code']?>" style="display: inline-block;">
                                                    ...
                                                    <div class="caption" style="display: none;">
                                                        ...
                                                        <p>
                                                            <? if($val['is_show']==1){ ?>
                                                                <a class="label label-default mix-zoom mrs" href="/fc_project/setShow?attach_id=<?=$val['attach_id']?>&project_id=<?=$val['project_id']?>&pic_id=<?=$val['id']?>&set=0" >取消</a>
                                                            <?}else{?>
                                                                <a class="label label-danger mix-zoom mrs" href="/fc_project/setShow?attach_id=<?=$val['attach_id']?>&project_id=<?=$val['project_id']?>&pic_id=<?=$val['id']?>&set=1" >显示</a>
                                                            <?}?>
                                                            <a class="label label-success mrs" href="" data-original-title="Save as">编辑</a>
                                                            <a class="label label-default" href="" data-original-title="Save as">删除</a>
...
function addPic(project_id)
{
	art.dialog.open('/fc_project/addPic?project_id='+project_id,{
		title: '',
		width: '85%',
		height: '90%',
		lock: 'true',
...
function editPic(pic_id,project_id)
{
	art.dialog.open('/fc_project/editPic?project_id='+project_id+'&id='+pic_id,{
		title: '',
		width: '85%',
		height: '90%',
		lock: 'true',
