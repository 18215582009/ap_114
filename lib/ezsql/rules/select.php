<?php
/**
 * $Id: select.php 246 2015-10-21 04:48:09Z $
 * @author deathking(751450467@qq.com)
 */
namespace lib\ezsql\rules\select;
use lib\ezsql\rules\basic\BasicRule;
use lib\ezsql\impls\ExecImpl;
use lib\ezsql\impls\SelectImpl;
use lib\ezsql\impls\FromImpl;
use lib\ezsql\impls\JoinImpl;
use lib\ezsql\impls\JoinOnImpl;
use lib\ezsql\impls\WhereImpl;
use lib\ezsql\impls\GroupByImpl;
use lib\ezsql\impls\OrderByImpl;
use lib\ezsql\impls\LimitImpl;
use lib\ezsql\impls\ForUpdateOfImpl;
use lib\ezsql\impls\ForUpdateImpl;
...
class SelectRule extends BasicRule
{
     ...
     * @return \ezsql\rules\select\FromRule
     */
...
class FromRule extends GetRule
{
     ...
     * @param string $table
     * @return \ezsql\rules\select\JoinRule
     */
...
class ForUpdateOfRule extends GetRule
{
     ...
     * @param string $column
     * @return \ezsql\rules\select\GetRule
     */
...
class ForUpdateRule extends GetRule
{
     ...
     * @return \ezsql\rules\select\ForUpdateOfRule
     */
...
class LimitRule extends ForUpdateRule
{
     ...
     * @param int $start
     * @param int $size
     * @return \ezsql\rules\select\ForUpdateRule 
     */
...
class OrderByRule extends LimitRule
{
     ...
     * @return \ezsql\rules\select\OrderByRule
     */
...
class GroupByRule extends OrderByRule
{
     ...
     * @param string $column
     * @return \ezsql\rules\select\HavingRule
     */
...
class WhereRule extends GroupByRule
{
     ...
     * @param string $expr
     * @param mixed $_
     * @return \ezsql\rules\select\GroupByRule
     */
...
class JoinRule extends WhereRule
{
     ...
     * @param string $table
     * @return \ezsql\rules\select\JoinOnRule
     */
