...
use lib\ezsql\rules\select\SelectRule;
use lib\ezsql\rules\insert\InsertRule;
use lib\ezsql\rules\update\UpdateRule;
use lib\ezsql\rules\delete\DeleteRule;
use lib\ezsql\rules\basic\BasicRule;
use lib\ezsql\rules\replace\ReplaceIntoRule;
