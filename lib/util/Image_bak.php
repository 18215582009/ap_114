...
class Image {
     ...
     * @return void
     */
    static function thumb($image, $type='', $thumbname, $maxWidth=200, $maxHeight=50, $interlace=true,$suffix='_thumb') {
        // 获取原图信息
        ...
        if ($info !== false) {
			...
			$thumbname  = empty($thumbname)? substr($image,0,strrpos($image, '.')).$suffix.'.'.$type : $filename;
